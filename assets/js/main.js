...
<div class="nav-wrapper">
    <a href="#!" class="brand-logo"><img src="images/web_image.png" ></a>
    <!--hamburger icon -->
    ...
    <ul class="right hide-on-med-and-down">
        ...
        <li><a class="white-text" href="https://drive.google.com/file/d/1y6cBrYLQeHujuBPlX6AG3ArLNSidGS_2/view" target="_blank">My Resume</a></li>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-7">
        <a class="webintern-footer-logo" href="#">
          <center><img src="images/web_image.png"style="width: 220px;"/></center>
        </a>
...
<div class="social-icons-footer">
  <a class="social-icon-footer twitter" href="https://twitter.com/AnjaliK54757047" target="_blank" rel="author">
    <i class="fab fa-twitter"></i>
      </a>
  <a class="social-icon-footer dribbble" href="https://devpost.com/anjali1361" target="_blank" rel="author">
    <i class="fab fa-dev"></i>
      </a>
  <a class="social-icon-footer linkedin" href="https://www.linkedin.com/in/anjali1361/" target="_blank" rel="author">
    <i class="fab fa-linkedin-in"></i>
      </a>
  <a class="social-icon-footer medium" href="https://www.facebook.com/anjali1361/" target="_blank" rel="author">
    <i class="fab fa-facebook-f"></i>
      </a>
  <a class="social-icon-footer kaggle" href="https://www.hackerrank.com/anjalikumari1361" target="_blank" rel="author">
    <i class="fab fa-hackerrank"></i>
      </a>
  <a class="social-icon-footer github" href="https://github.com/anjali1361" target="_blank" rel="author">
